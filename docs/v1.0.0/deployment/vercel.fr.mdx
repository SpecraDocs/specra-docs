...
Vercel est le moyen le plus simple de déployer votre documentation Specra. Il est construit par les créateurs de SvelteKit, donc tout fonctionne parfaitement dès la sortie de la boîte.
...
```
  ...
  <Step title="Importer dans Vercel">
    ...
    4. Vercel détecte automatiquement SvelteKit et configure tout
...
Vercel utilise automatiquement ces paramètres pour les projets SvelteKit :
...
- **Optimisation d'image** - Composant Image SvelteKit optimisé automatiquement
