...
```bash
npx create-specra@latest deploy
```
  </Step>
...
<CardGrid cols={2}>
  <Card
    icon="terminal"
    title="CLI Reference"
    description="All CLI commands — deploy, login, doctor, and more"
  ...
  <Card
    icon="settings"
    title="Configuration"
    description="Configure your site metadata and features"
    href="/docs/v1.0.0/configuration/overview"
  />
  <Card
    icon="palette"
    title="Customization"
    description="Theme and brand your documentation"
