...
**Les ressources se chargent depuis :** `/nom-repo/_app/immutable/...`
...
**Commande de build :** `npm run build:export`
**Sortie :** Répertoire `out`
**Les ressources se chargent depuis :** `/_app/immutable/...`
...
3. Déployer le dossier `out/` au lieu de `.svelte-kit/`
