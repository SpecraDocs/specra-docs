...
**Los activos se cargan de:** `/nombre-repo/_app/immutable/...`
...
**Comando de compilación:** `npm run build:export`
**Salida:** directorio `out`
**Los activos se cargan de:** `/_app/immutable/...`
...
3. Implementar carpeta `out/` en lugar de `.svelte-kit/`
