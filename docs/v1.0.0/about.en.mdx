...
<CardGrid cols={2}>
  ...
  <Card icon="code" title="MDX Components" description="Use Markdown for content, Svelte components for interactivity. Best of both worlds." />
...
<Steps>
  <Step title="Write in MDX">
    Create `.mdx` files in your `docs/` folder. Use frontmatter for metadata. Write Markdown for content. Mix in Svelte components when needed.
  </Step>
  ...
  <Step title="Deploy">
    Run `create-specra deploy` to ship to Specra Cloud — automatic HTTPS, custom subdomain, and built-in analytics. Or self-host with any static or Node.js platform.
  </Step>
</Steps>
...
**specra-docs** (this site) — The official documentation and SaaS platform at [specra-docs.com](https://specra-docs.com). Built with the Specra SDK, it also includes authentication (Auth.js), subscription billing (Stripe + M-Pesa), a user dashboard, and an admin panel. The SaaS features are specific to this site and are not part of the SDK.
