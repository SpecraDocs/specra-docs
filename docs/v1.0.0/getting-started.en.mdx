...
├── package.json
├── svelte.config.js         # SvelteKit config (auto-managed)
...
*italic text*, and even [links](https://specra-docs.com).
...
<CardGrid cols={2}>
  ...
  <Card icon="rocket" title="Deploy Your Docs" description="Ship your documentation to Specra Cloud" href="/docs/v1.0.0/deployment/specra-cloud" />
